...
<?php
 ...
 if(isset($_GET['id'])){
    ...
    if(isset($_POST['ajout'])){
        ...
        $email = $_POST['email'];
        $statut = $_POST['statut'];
        if(!empty($id)&& !empty($lastName)&& !empty($firstName)&& !empty($email)&& !empty($statut) && !empty($passwordvalid)){
...
<body>
     <form action="#" method="post" class="form-group p-3 mb-5 bg-dark rounded">
    <h1> Inscription </h1>
    ...
    <div class="form-group">
     ...
     <div class="form-group">
        ...
        <input type="text" class="form-control" name="password" id="ipassword"/>
    </div>
    <div class="form-group">
